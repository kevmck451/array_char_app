...
class SpeakerControlApp(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        self.file_listbox = Listbox(self.left_frame, selectmode=SINGLE)
        self.file_listbox.pack(side=ctk.LEFT, fill=ctk.Y, expand=True)
        ...
        self.sequence_1_button = ctk.CTkButton(self.left_frame, text="Sequence 1")
        self.sequence_1_button.pack(pady=5)

        self.sequence_2_button = ctk.CTkButton(self.left_frame, text="Sequence 2")
        self.sequence_2_button.pack(pady=5)

        self.canvas = ctk.CTkCanvas(self.top_frame, width=self.canvas_size, height=self.canvas_size, bg='#1e1e1e')
